...
projects: []
summary: Here you can find a tentative course schedule. While we will try to carry out the course in person, it is possible that we have to switch to online classes at some point. 
...
```{r echo=FALSE, warning=FALSE, message=FALSE,  fig.asp=0.9, out.width="100%"}
...
cal %>%
  ...
  geom_text(
    ...
    aes(x = .x, label = day), y = 1.07, size = 4,
    hjust = 1, color = "#0B0405", family = "Indie Flower"
  ) +
  ...
  labs(title = "QM 2021: Semester Overview",
       subtitle = "   ",
       caption = "Welcome Session, Lecture 1, and Lab 1 take place online.") +
  coord_cartesian(xlim = c(-0.2, 1.03), clip = "off")
